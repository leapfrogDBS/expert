    ...
    <li class="items-start group text-center">
        ...
        if (str_contains($classes, 'mega-menu')) {
           ?>
            ...
            <p class="title text-base font-normal mb-0 px-2 py-2 cursor-pointer xl:text-xl <?php echo $classes; ?>" aria-haspopup="true">
                <?php echo $title; ?>
        </p>
        <?php    
        } else {  
        ?>
            <a href="<?php echo $link; ?>" class="title text-base font-normal mb-0 px-2 py-2 xl:text-xl <?php echo $classes; ?>" <?php echo $popup; ?>> 
            <?php echo $title; ?>
        </a>
    <?php } 
    endif; ?>
