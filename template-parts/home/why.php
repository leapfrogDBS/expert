    ...
    <div class="container">
        <div class="row mb-24 items-center">
            ...
            <div class="col lg:col-span-5 lg:col-start-8 relative mt-16 lg:mt-0">
                ...
                <img loading="lazy" class="lg:hidden m-auto w-52 h-auto mb-8" src="<?php echo get_template_directory_uri(); ?>/img/why1-mobile.svg" alt="">
                ...
                <img loading="lazy" class="lg:hidden m-auto w-52 h-full mb-8" src="<?php echo get_template_directory_uri(); ?>/img/why2-mobile.svg" alt="">
