            ...
            <div class="row">
                <div class="col md:col-span-8 md:col-start-3">
                    ...
                    <figure class="content-media content-media--video rounded-xl" id="featured-media">
                        <iframe loading="lazy" class="content-media__object z-40 rounded-xl" id="featured-video" src="<?php echo $header_video; ?>?enablejsapi=1&rel=0&showinfo=0&controls=0" frameborder="0"></iframe>
                    </figure>
                </div>
            </div>
        <?php
